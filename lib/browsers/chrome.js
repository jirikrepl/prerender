...
chrome.spawn = function (options) {
	return new Promise((resolve, reject) => {
		...
		// /Applications/Google\ Chrome.app/Contents/MacOS/Google\ Chrome --headless --disable-gpu --remote-debugging-port=9922 --hide-scrollbars
		...
		this.chromeChild = spawn(location, this.options.chromeFlags || [
			...
			'--enable-logging',
			'--v=1',
			// '--user-data-dir=/home/jirka/chrome-profile' // logs will be saved here
		], {shell: true});
